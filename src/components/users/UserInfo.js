  ...
  return (
    <Wrapper>
      ...
      <div className="user__links">
        {github && (
          <a href={`https://github.com/${github}`} className="user__link" title={`View ${github} on GitHub`} target="_blank" rel="">
        ...
        {twitter && (
          <a href={`https://twitter.com/${twitter}`} className="user__link" title={`View ${twitter} on Twitter`} target="_blank" rel="">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 30 30">
