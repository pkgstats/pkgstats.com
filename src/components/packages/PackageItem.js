  ...
  renderLinks() {
    ...
    ['npm', 'repository', 'homepage'].forEach(linkType => {
      if (pkg.package.links && pkg.package.links.hasOwnProperty(linkType)) {
        ...
        switch (linkType) {
          case 'npm':
            linkTitle = 'View on npm';
            linkIconUrl = '/static/svgs/npm-icon.svg';
          ...
          case 'repository':
            ...
            linkIconUrl = '/static/svgs/repository-icon.svg';
          ...
          default:
            linkTitle = 'View package site';
            linkIconUrl = '/static/svgs/globe-icon.svg';
        ...
        links.push((
          <a
            ...
            title={linkTitle}
          ><img src={linkIconUrl} alt={linkType} /></a>
        ));
      }
    });
